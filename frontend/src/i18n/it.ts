...
export const it = {
  ...
  detail: {
    ...
    copyLink: "Copia link",
    copied: "Copiato",
    chooseSource: "Scegli la sorgente",
    downloadPreparing: "Ricostruzione del file sul server…",
    downloadReady: "Pronto — clicca per salvare",
    downloadFailed: "Download fallito",
    ffmpegMissing: "ffmpeg non è installato sul server",
  },
  library: {
    title: "Libreria",
